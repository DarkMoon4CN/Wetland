/*
 *参考轮子：https://download.csdn.net/download/yun738243875/9988073 
 */
...
namespace Open.SchoolBase.ExpressionVisitor
{
    ...
    public class ExpressionParameterizedSqlWriter : ExpressionVisitor
    {
        ...
        public ExpressionParameterizedSqlWriter(List<object> parameters)
        {
        ...
        protected override Expression VisitConstant(ConstantExpression c)
        {
            ...
            {
                m_sb.Append($"@p{m_parameters.Count}");
